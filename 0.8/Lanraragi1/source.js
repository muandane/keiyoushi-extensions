...
var _Sources = (() => {
  ...
  // src/Lanraragi1/Lanraragi1.ts
  var Lanraragi1_exports = {};
  __export(Lanraragi1_exports, {
    Lanraragi1: () => Lanraragi1,
    Lanraragi1Info: () => Lanraragi1Info
  });
  var import_types2 = __toESM(require_lib());

  // src/Lanraragi1/Lanraragi1Parser.ts
  ...
  // src/Lanraragi1/Lanraragi1Settings.ts
  ...
  // src/Lanraragi1/Lanraragi1.ts
  var LANRARAGI1_DOMAIN = "http://127.0.0.1:3000";
  var Lanraragi1Info = {
    version: "1.0.0",
    name: "LANraragi (1)",
    icon: "icon.png",
  ...
  return __toCommonJS(Lanraragi1_exports);
})();
