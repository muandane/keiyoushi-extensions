...
var _Sources = (() => {
  ...
  // src/Readjujutsukaisenmangaonline/Readjujutsukaisenmangaonline.ts
  var Readjujutsukaisenmangaonline_exports = {};
  __export(Readjujutsukaisenmangaonline_exports, {
    Readjujutsukaisenmangaonline: () => Readjujutsukaisenmangaonline,
    ReadjujutsukaisenmangaonlineInfo: () => ReadjujutsukaisenmangaonlineInfo
  });
  var import_types2 = __toESM(require_lib());

  // src/Readjujutsukaisenmangaonline/ReadjujutsukaisenmangaonlineParser.ts
  ...
  // src/Readjujutsukaisenmangaonline/ReadjujutsukaisenmangaonlineSettings.ts
  ...
  // src/Readjujutsukaisenmangaonline/Readjujutsukaisenmangaonline.ts
  var READJUJUTSUKAISENMANGAONLINE_DOMAIN = "https://ww5.readjujutsukaisen.com";
  var ReadjujutsukaisenmangaonlineInfo = {
    version: "1.0.0",
    name: "Read Jujutsu Kaisen Manga Online",
    icon: "icon.png",
    author: "Generated",
    authorWebsite: "",
    description: "Extension that pulls manga from Read Jujutsu Kaisen Manga Online",
    contentRating: import_types2.ContentRating.EVERYONE,
    websiteBaseURL: READJUJUTSUKAISENMANGAONLINE_DOMAIN,
  ...
  var Readjujutsukaisenmangaonline = class {
    constructor(cheerio) {
      this.cheerio = cheerio;
        ...
        interceptor: {
          interceptRequest: async (request) => {
            request.headers = {
              ...request.headers ?? {},
              ...{
                "referer": `${READJUJUTSUKAISENMANGAONLINE_DOMAIN}/`,
    ...
    getMangaShareUrl(mangaId) {
      return `${READJUJUTSUKAISENMANGAONLINE_DOMAIN}/${mangaId}`;
    }
    async getMangaDetails(mangaId) {
      const request = App.createRequest({
        url: `${READJUJUTSUKAISENMANGAONLINE_DOMAIN}/${mangaId}`,
        method: "GET"
      });
    ...
    async getChapterDetails(mangaId, chapterId) {
      const request = App.createRequest({
        url: `${READJUJUTSUKAISENMANGAONLINE_DOMAIN}/${chapterId}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getHomePageSections(sectionCallback) {
      const request = App.createRequest({
        url: READJUJUTSUKAISENMANGAONLINE_DOMAIN,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getViewMoreItems(homepageSectionId, metadata) {
      ...
      const request = App.createRequest({
        url: `${READJUJUTSUKAISENMANGAONLINE_DOMAIN}/${homepageSectionId}?page=${page}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getSearchResults(query, metadata) {
      ...
      const request = App.createRequest({
        url: `${READJUJUTSUKAISENMANGAONLINE_DOMAIN}/search?q=${searchQuery}&page=${page}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
  ...
  return __toCommonJS(Readjujutsukaisenmangaonline_exports);
})();
