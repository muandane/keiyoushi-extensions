...
var _Sources = (() => {
  ...
  // src/Mangaup/Mangaup.ts
  var Mangaup_exports = {};
  __export(Mangaup_exports, {
    Mangaup: () => Mangaup,
    MangaupInfo: () => MangaupInfo
  });
  var import_types = __toESM(require_lib());

  // src/Mangaup/MangaupParser.ts
  ...
  // src/Mangaup/MangaupSettings.ts
  ...
  // src/Mangaup/Mangaup.ts
  var MANGAUP_DOMAIN = "https://global.manga-up.com";
  var MangaupInfo = {
    version: "1.0.0",
    name: "Manga UP!",
    icon: "icon.png",
  ...
  return __toCommonJS(Mangaup_exports);
})();
