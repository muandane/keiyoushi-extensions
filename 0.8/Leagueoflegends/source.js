...
var _Sources = (() => {
  ...
  // src/Leagueoflegends/Leagueoflegends.ts
  var Leagueoflegends_exports = {};
  __export(Leagueoflegends_exports, {
    Leagueoflegends: () => Leagueoflegends,
    LeagueoflegendsInfo: () => LeagueoflegendsInfo
  });
  var import_types2 = __toESM(require_lib());

  // src/Leagueoflegends/LeagueoflegendsParser.ts
  ...
  // src/Leagueoflegends/LeagueoflegendsSettings.ts
  ...
  // src/Leagueoflegends/Leagueoflegends.ts
  var LEAGUEOFLEGENDS_DOMAIN = "https://universe.leagueoflegends.com";
  var LeagueoflegendsInfo = {
    version: "1.0.0",
    name: "League of Legends",
    icon: "icon.png",
    author: "Generated",
    authorWebsite: "",
    description: "Extension that pulls manga from League of Legends",
    contentRating: import_types2.ContentRating.EVERYONE,
    websiteBaseURL: LEAGUEOFLEGENDS_DOMAIN,
  ...
  var Leagueoflegends = class {
        ...
        interceptor: {
          interceptRequest: async (request) => {
            request.headers = {
              ...request.headers ?? {},
              ...{
                "referer": `${LEAGUEOFLEGENDS_DOMAIN}/`,
    ...
    getMangaShareUrl(mangaId) {
      return `${LEAGUEOFLEGENDS_DOMAIN}/${mangaId}`;
    }
    async getMangaDetails(mangaId) {
      const request = App.createRequest({
        url: `${LEAGUEOFLEGENDS_DOMAIN}/${mangaId}`,
        method: "GET"
      });
    ...
    async getChapterDetails(mangaId, chapterId) {
      const request = App.createRequest({
        url: `${LEAGUEOFLEGENDS_DOMAIN}/${chapterId}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getViewMoreItems(homepageSectionId, metadata) {
      ...
      const request = App.createRequest({
        url: `${LEAGUEOFLEGENDS_DOMAIN}/${homepageSectionId}?page=${page}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getSearchResults(query, metadata) {
      ...
      const request = App.createRequest({
        url: `${LEAGUEOFLEGENDS_DOMAIN}/search?q=${searchQuery}&page=${page}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
  ...
  return __toCommonJS(Leagueoflegends_exports);
})();
