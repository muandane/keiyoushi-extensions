...
var _Sources = (() => {
  ...
  // src/Lanraragi2/Lanraragi2.ts
  var Lanraragi2_exports = {};
  __export(Lanraragi2_exports, {
    Lanraragi2: () => Lanraragi2,
    Lanraragi2Info: () => Lanraragi2Info
  });
  var import_types2 = __toESM(require_lib());

  // src/Lanraragi2/Lanraragi2Parser.ts
  ...
  // src/Lanraragi2/Lanraragi2Settings.ts
  ...
  // src/Lanraragi2/Lanraragi2.ts
  var LANRARAGI2_DOMAIN = "http://127.0.0.1:3000";
  var Lanraragi2Info = {
    version: "1.0.0",
    name: "LANraragi (2)",
    icon: "icon.png",
    author: "Generated",
    authorWebsite: "",
    description: "Extension that pulls manga from LANraragi (2)",
    contentRating: import_types2.ContentRating.EVERYONE,
    websiteBaseURL: LANRARAGI2_DOMAIN,
  ...
  var Lanraragi2 = class {
    ...
    getMangaShareUrl(mangaId) {
      return `${LANRARAGI2_DOMAIN}/${mangaId}`;
    }
    async getMangaDetails(mangaId) {
      const request = App.createRequest({
        url: `${LANRARAGI2_DOMAIN}/${mangaId}`,
        method: "GET"
      });
    ...
    async getChapterDetails(mangaId, chapterId) {
      const request = App.createRequest({
        url: `${LANRARAGI2_DOMAIN}/${chapterId}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getViewMoreItems(homepageSectionId, metadata) {
      ...
      const request = App.createRequest({
        url: `${LANRARAGI2_DOMAIN}/${homepageSectionId}?page=${page}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getSearchResults(query, metadata) {
      ...
      const request = App.createRequest({
        url: `${LANRARAGI2_DOMAIN}/search?q=${searchQuery}&page=${page}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
  ...
  return __toCommonJS(Lanraragi2_exports);
})();
