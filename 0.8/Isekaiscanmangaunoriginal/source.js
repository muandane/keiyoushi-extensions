...
var _Sources = (() => {
  ...
  // src/Isekaiscanmangaunoriginal/Isekaiscanmangaunoriginal.ts
  var Isekaiscanmangaunoriginal_exports = {};
  __export(Isekaiscanmangaunoriginal_exports, {
    Isekaiscanmangaunoriginal: () => Isekaiscanmangaunoriginal,
    IsekaiscanmangaunoriginalInfo: () => IsekaiscanmangaunoriginalInfo
  });
  var import_types2 = __toESM(require_lib());

  // src/Isekaiscanmangaunoriginal/IsekaiscanmangaunoriginalParser.ts
  ...
  // src/Isekaiscanmangaunoriginal/IsekaiscanmangaunoriginalSettings.ts
  ...
  // src/Isekaiscanmangaunoriginal/Isekaiscanmangaunoriginal.ts
  var ISEKAISCANMANGAUNORIGINAL_DOMAIN = "https://isekaiscanmanga.com";
  var IsekaiscanmangaunoriginalInfo = {
    version: "1.0.0",
    name: "IsekaiScanManga (unoriginal)",
    icon: "icon.png",
    author: "Generated",
    authorWebsite: "",
    description: "Extension that pulls manga from IsekaiScanManga (unoriginal)",
    contentRating: import_types2.ContentRating.EVERYONE,
    websiteBaseURL: ISEKAISCANMANGAUNORIGINAL_DOMAIN,
  ...
  var Isekaiscanmangaunoriginal = class {
    constructor(cheerio) {
      this.cheerio = cheerio;
    ...
    async getMangaDetails(mangaId) {
      const request = App.createRequest({
        url: `${ISEKAISCANMANGAUNORIGINAL_DOMAIN}/${mangaId}`,
        method: "GET"
      });
    ...
    async getChapterDetails(mangaId, chapterId) {
      const request = App.createRequest({
        url: `${ISEKAISCANMANGAUNORIGINAL_DOMAIN}/${chapterId}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getHomePageSections(sectionCallback) {
      const request = App.createRequest({
        url: ISEKAISCANMANGAUNORIGINAL_DOMAIN,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getViewMoreItems(homepageSectionId, metadata) {
      ...
      const request = App.createRequest({
        url: `${ISEKAISCANMANGAUNORIGINAL_DOMAIN}/${homepageSectionId}?page=${page}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getSearchResults(query, metadata) {
      ...
      const request = App.createRequest({
        url: `${ISEKAISCANMANGAUNORIGINAL_DOMAIN}/search?q=${searchQuery}&page=${page}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
  ...
  return __toCommonJS(Isekaiscanmangaunoriginal_exports);
})();
