...
var _Sources = (() => {
  ...
  // src/Msytoon/Msytoon.ts
  var Msytoon_exports = {};
  __export(Msytoon_exports, {
    Msytoon: () => Msytoon,
    MsytoonInfo: () => MsytoonInfo
  });
  var import_types2 = __toESM(require_lib());

  // src/Msytoon/MsytoonParser.ts
  ...
  // src/Msytoon/MsytoonSettings.ts
  ...
  // src/Msytoon/Msytoon.ts
  var MSYTOON_DOMAIN = "https://msytoon.com";
  var MsytoonInfo = {
    version: "1.0.0",
    name: "MSYToon",
    icon: "icon.png",
  ...
  return __toCommonJS(Msytoon_exports);
})();
