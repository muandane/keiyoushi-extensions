...
var _Sources = (() => {
  ...
  // src/Comikey/Comikey.ts
  var Comikey_exports = {};
  __export(Comikey_exports, {
    Comikey: () => Comikey,
    ComikeyInfo: () => ComikeyInfo
  });
  var import_types2 = __toESM(require_lib());

  // src/Comikey/ComikeyParser.ts
  ...
  var parseHomeSections = ($, sectionCallback) => {
    ...
    for (const element of mangaElements.slice(0, 20)) {
      const title = $('[class*="series"] .title', element).first().text().trim();
  ...
  // src/Comikey/ComikeySettings.ts
  ...
  // src/Comikey/Comikey.ts
  var COMIKEY_DOMAIN = "https://comikey.com";
  var ComikeyInfo = {
    version: "1.0.0",
    name: "Comikey",
    icon: "icon.png",
  ...
  return __toCommonJS(Comikey_exports);
})();
