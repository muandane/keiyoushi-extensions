...
var _Sources = (() => {
  ...
  // src/Readfairytailedenszeromangaonline/Readfairytailedenszeromangaonline.ts
  var Readfairytailedenszeromangaonline_exports = {};
  __export(Readfairytailedenszeromangaonline_exports, {
    Readfairytailedenszeromangaonline: () => Readfairytailedenszeromangaonline,
    ReadfairytailedenszeromangaonlineInfo: () => ReadfairytailedenszeromangaonlineInfo
  });
  var import_types = __toESM(require_lib());

  // src/Readfairytailedenszeromangaonline/ReadfairytailedenszeromangaonlineParser.ts
  ...
  // src/Readfairytailedenszeromangaonline/ReadfairytailedenszeromangaonlineSettings.ts
  ...
  // src/Readfairytailedenszeromangaonline/Readfairytailedenszeromangaonline.ts
  var READFAIRYTAILEDENSZEROMANGAONLINE_DOMAIN = "https://ww8.readfairytail.com";
  var ReadfairytailedenszeromangaonlineInfo = {
    version: "1.0.0",
    name: "Read Fairy Tail & Edens Zero Manga Online",
    icon: "icon.png",
    author: "Generated",
    authorWebsite: "",
    description: "Extension that pulls manga from Read Fairy Tail & Edens Zero Manga Online",
    contentRating: import_types.ContentRating.EVERYONE,
    websiteBaseURL: READFAIRYTAILEDENSZEROMANGAONLINE_DOMAIN,
  ...
  var Readfairytailedenszeromangaonline = class {
    constructor(cheerio) {
      this.cheerio = cheerio;
        ...
        interceptor: {
          interceptRequest: async (request) => {
            request.headers = {
              ...request.headers ?? {},
              ...{
                "referer": `${READFAIRYTAILEDENSZEROMANGAONLINE_DOMAIN}/`,
    ...
    getMangaShareUrl(mangaId) {
      return `${READFAIRYTAILEDENSZEROMANGAONLINE_DOMAIN}/${mangaId}`;
    }
    async getMangaDetails(mangaId) {
      const request = App.createRequest({
        url: `${READFAIRYTAILEDENSZEROMANGAONLINE_DOMAIN}/${mangaId}`,
        method: "GET"
      });
    ...
    async getChapterDetails(mangaId, chapterId) {
      const request = App.createRequest({
        url: `${READFAIRYTAILEDENSZEROMANGAONLINE_DOMAIN}/${chapterId}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getHomePageSections(sectionCallback) {
      const request = App.createRequest({
        url: READFAIRYTAILEDENSZEROMANGAONLINE_DOMAIN,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getViewMoreItems(homepageSectionId, metadata) {
      ...
      const request = App.createRequest({
        url: `${READFAIRYTAILEDENSZEROMANGAONLINE_DOMAIN}/${homepageSectionId}?page=${page}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getSearchResults(query, metadata) {
      ...
      const request = App.createRequest({
        url: `${READFAIRYTAILEDENSZEROMANGAONLINE_DOMAIN}/search?q=${searchQuery}&page=${page}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
  ...
  return __toCommonJS(Readfairytailedenszeromangaonline_exports);
})();
