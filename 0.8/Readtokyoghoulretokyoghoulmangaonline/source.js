...
var _Sources = (() => {
  ...
  // src/Readtokyoghoulretokyoghoulmangaonline/Readtokyoghoulretokyoghoulmangaonline.ts
  var Readtokyoghoulretokyoghoulmangaonline_exports = {};
  __export(Readtokyoghoulretokyoghoulmangaonline_exports, {
    Readtokyoghoulretokyoghoulmangaonline: () => Readtokyoghoulretokyoghoulmangaonline,
    ReadtokyoghoulretokyoghoulmangaonlineInfo: () => ReadtokyoghoulretokyoghoulmangaonlineInfo
  });
  var import_types2 = __toESM(require_lib());

  // src/Readtokyoghoulretokyoghoulmangaonline/ReadtokyoghoulretokyoghoulmangaonlineParser.ts
  ...
  // src/Readtokyoghoulretokyoghoulmangaonline/ReadtokyoghoulretokyoghoulmangaonlineSettings.ts
  ...
  // src/Readtokyoghoulretokyoghoulmangaonline/Readtokyoghoulretokyoghoulmangaonline.ts
  var READTOKYOGHOULRETOKYOGHOULMANGAONLINE_DOMAIN = "https://ww11.tokyoghoulre.com";
  var ReadtokyoghoulretokyoghoulmangaonlineInfo = {
    version: "1.0.0",
    name: "Read Tokyo Ghoul Re & Tokyo Ghoul Manga Online",
    icon: "icon.png",
    author: "Generated",
    authorWebsite: "",
    description: "Extension that pulls manga from https://ww11.tokyoghoulre.com",
    contentRating: import_types2.ContentRating.EVERYONE,
    websiteBaseURL: "https://ww11.tokyoghoulre.com",
  ...
  var Readtokyoghoulretokyoghoulmangaonline = class {
    constructor() {
  ...
  return __toCommonJS(Readtokyoghoulretokyoghoulmangaonline_exports);
})();
