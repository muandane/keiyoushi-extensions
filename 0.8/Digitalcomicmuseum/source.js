...
var _Sources = (() => {
  ...
  // src/Digitalcomicmuseum/Digitalcomicmuseum.ts
  var Digitalcomicmuseum_exports = {};
  __export(Digitalcomicmuseum_exports, {
    Digitalcomicmuseum: () => Digitalcomicmuseum,
    DigitalcomicmuseumInfo: () => DigitalcomicmuseumInfo
  });
  var import_types2 = __toESM(require_lib());

  // src/Digitalcomicmuseum/DigitalcomicmuseumParser.ts
  ...
  // src/Digitalcomicmuseum/DigitalcomicmuseumSettings.ts
  ...
  // src/Digitalcomicmuseum/Digitalcomicmuseum.ts
  var DIGITALCOMICMUSEUM_DOMAIN = "https://digitalcomicmuseum.com";
  var DigitalcomicmuseumInfo = {
    version: "1.0.0",
    name: "Digital Comic Museum",
    icon: "icon.png",
    author: "Generated",
    authorWebsite: "",
    description: "Extension that pulls manga from Digital Comic Museum",
    contentRating: import_types2.ContentRating.EVERYONE,
    websiteBaseURL: DIGITALCOMICMUSEUM_DOMAIN,
  ...
  var Digitalcomicmuseum = class {
    ...
    async getMangaDetails(mangaId) {
      const request = App.createRequest({
        url: `${DIGITALCOMICMUSEUM_DOMAIN}/${mangaId}`,
        method: "GET"
      });
    ...
    async getChapterDetails(mangaId, chapterId) {
      const request = App.createRequest({
        url: `${DIGITALCOMICMUSEUM_DOMAIN}/${chapterId}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getViewMoreItems(homepageSectionId, metadata) {
      ...
      const request = App.createRequest({
        url: `${DIGITALCOMICMUSEUM_DOMAIN}/${homepageSectionId}?page=${page}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getSearchResults(query, metadata) {
      ...
      const request = App.createRequest({
        url: `${DIGITALCOMICMUSEUM_DOMAIN}/search?q=${searchQuery}&page=${page}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
  ...
  return __toCommonJS(Digitalcomicmuseum_exports);
})();
