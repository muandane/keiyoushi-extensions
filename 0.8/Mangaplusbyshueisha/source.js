...
var _Sources = (() => {
  ...
  // src/Mangaplusbyshueisha/Mangaplusbyshueisha.ts
  var Mangaplusbyshueisha_exports = {};
  __export(Mangaplusbyshueisha_exports, {
    Mangaplusbyshueisha: () => Mangaplusbyshueisha,
    MangaplusbyshueishaInfo: () => MangaplusbyshueishaInfo
  });
  var import_types2 = __toESM(require_lib());

  // src/Mangaplusbyshueisha/MangaplusbyshueishaParser.ts
  ...
  // src/Mangaplusbyshueisha/MangaplusbyshueishaSettings.ts
  ...
  // src/Mangaplusbyshueisha/Mangaplusbyshueisha.ts
  var MANGAPLUSBYSHUEISHA_DOMAIN = "https://mangaplus.shueisha.co.jp";
  var MangaplusbyshueishaInfo = {
    version: "1.0.0",
    name: "MANGA Plus by SHUEISHA",
    icon: "icon.png",
    author: "Generated",
    authorWebsite: "",
    description: "Extension that pulls manga from MANGA Plus by SHUEISHA",
    contentRating: import_types2.ContentRating.EVERYONE,
    websiteBaseURL: MANGAPLUSBYSHUEISHA_DOMAIN,
  ...
  var Mangaplusbyshueisha = class {
    ...
    async getMangaDetails(mangaId) {
      const request = App.createRequest({
        url: `${MANGAPLUSBYSHUEISHA_DOMAIN}/${mangaId}`,
        method: "GET"
      });
    ...
    async getChapterDetails(mangaId, chapterId) {
      const request = App.createRequest({
        url: `${MANGAPLUSBYSHUEISHA_DOMAIN}/${chapterId}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getHomePageSections(sectionCallback) {
      const request = App.createRequest({
        url: MANGAPLUSBYSHUEISHA_DOMAIN,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getViewMoreItems(homepageSectionId, metadata) {
      ...
      const request = App.createRequest({
        url: `${MANGAPLUSBYSHUEISHA_DOMAIN}/${homepageSectionId}?page=${page}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getSearchResults(query, metadata) {
      ...
      const request = App.createRequest({
        url: `${MANGAPLUSBYSHUEISHA_DOMAIN}/search?q=${searchQuery}&page=${page}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
  ...
  return __toCommonJS(Mangaplusbyshueisha_exports);
})();
