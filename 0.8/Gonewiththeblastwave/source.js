...
var _Sources = (() => {
  ...
  // src/Gonewiththeblastwave/Gonewiththeblastwave.ts
  var Gonewiththeblastwave_exports = {};
  __export(Gonewiththeblastwave_exports, {
    Gonewiththeblastwave: () => Gonewiththeblastwave,
    GonewiththeblastwaveInfo: () => GonewiththeblastwaveInfo
  });
  var import_types2 = __toESM(require_lib());

  // src/Gonewiththeblastwave/GonewiththeblastwaveParser.ts
  ...
  // src/Gonewiththeblastwave/GonewiththeblastwaveSettings.ts
  ...
  // src/Gonewiththeblastwave/Gonewiththeblastwave.ts
  var GONEWITHTHEBLASTWAVE_DOMAIN = "https://www.blastwave-comic.com";
  var GonewiththeblastwaveInfo = {
    version: "1.0.0",
    name: "Gone with the Blastwave",
    icon: "icon.png",
    author: "Generated",
    authorWebsite: "",
    description: "Extension that pulls manga from https://www.blastwave-comic.com",
    contentRating: import_types2.ContentRating.EVERYONE,
    websiteBaseURL: "https://www.blastwave-comic.com",
  ...
  var Gonewiththeblastwave = class {
    constructor() {
  ...
  return __toCommonJS(Gonewiththeblastwave_exports);
})();
