...
var _Sources = (() => {
  ...
  // src/Readattackontitanshingekinokyojinmanga/Readattackontitanshingekinokyojinmanga.ts
  var Readattackontitanshingekinokyojinmanga_exports = {};
  __export(Readattackontitanshingekinokyojinmanga_exports, {
    Readattackontitanshingekinokyojinmanga: () => Readattackontitanshingekinokyojinmanga,
    ReadattackontitanshingekinokyojinmangaInfo: () => ReadattackontitanshingekinokyojinmangaInfo
  });
  var import_types2 = __toESM(require_lib());

  // src/Readattackontitanshingekinokyojinmanga/ReadattackontitanshingekinokyojinmangaParser.ts
  ...
  // src/Readattackontitanshingekinokyojinmanga/ReadattackontitanshingekinokyojinmangaSettings.ts
  ...
  // src/Readattackontitanshingekinokyojinmanga/Readattackontitanshingekinokyojinmanga.ts
  var READATTACKONTITANSHINGEKINOKYOJINMANGA_DOMAIN = "https://ww11.readsnk.com";
  var ReadattackontitanshingekinokyojinmangaInfo = {
    version: "1.0.0",
    name: "Read Attack on Titan Shingeki no Kyojin Manga",
    icon: "icon.png",
    author: "Generated",
    authorWebsite: "",
    description: "Extension that pulls manga from Read Attack on Titan Shingeki no Kyojin Manga",
    contentRating: import_types2.ContentRating.EVERYONE,
    websiteBaseURL: READATTACKONTITANSHINGEKINOKYOJINMANGA_DOMAIN,
  ...
  var Readattackontitanshingekinokyojinmanga = class {
    constructor(cheerio) {
      this.cheerio = cheerio;
    ...
    async getMangaDetails(mangaId) {
      const request = App.createRequest({
        url: `${READATTACKONTITANSHINGEKINOKYOJINMANGA_DOMAIN}/${mangaId}`,
        method: "GET"
      });
    ...
    async getChapterDetails(mangaId, chapterId) {
      const request = App.createRequest({
        url: `${READATTACKONTITANSHINGEKINOKYOJINMANGA_DOMAIN}/${chapterId}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getHomePageSections(sectionCallback) {
      const request = App.createRequest({
        url: READATTACKONTITANSHINGEKINOKYOJINMANGA_DOMAIN,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getViewMoreItems(homepageSectionId, metadata) {
      ...
      const request = App.createRequest({
        url: `${READATTACKONTITANSHINGEKINOKYOJINMANGA_DOMAIN}/${homepageSectionId}?page=${page}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getSearchResults(query, metadata) {
      ...
      const request = App.createRequest({
        url: `${READATTACKONTITANSHINGEKINOKYOJINMANGA_DOMAIN}/search?q=${searchQuery}&page=${page}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
  ...
  return __toCommonJS(Readattackontitanshingekinokyojinmanga_exports);
})();
