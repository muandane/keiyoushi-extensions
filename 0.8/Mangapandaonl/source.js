...
var _Sources = (() => {
  ...
  // src/Mangapandaonl/Mangapandaonl.ts
  var Mangapandaonl_exports = {};
  __export(Mangapandaonl_exports, {
    Mangapandaonl: () => Mangapandaonl,
    MangapandaonlInfo: () => MangapandaonlInfo
  });
  var import_types2 = __toESM(require_lib());

  // src/Mangapandaonl/MangapandaonlParser.ts
  ...
  // src/Mangapandaonl/MangapandaonlSettings.ts
  ...
  // src/Mangapandaonl/Mangapandaonl.ts
  var MANGAPANDAONL_DOMAIN = "https://mangapanda.onl";
  var MangapandaonlInfo = {
    version: "1.0.0",
    name: "MangaPanda.onl",
    icon: "icon.png",
    author: "Generated",
    authorWebsite: "",
    description: "Extension that pulls manga from MangaPanda.onl",
    contentRating: import_types2.ContentRating.EVERYONE,
    websiteBaseURL: MANGAPANDAONL_DOMAIN,
  ...
  var Mangapandaonl = class {
    ...
    getMangaShareUrl(mangaId) {
      return `${MANGAPANDAONL_DOMAIN}/${mangaId}`;
    }
    async getMangaDetails(mangaId) {
      const request = App.createRequest({
        url: `${MANGAPANDAONL_DOMAIN}/${mangaId}`,
        method: "GET"
      });
    ...
    async getChapterDetails(mangaId, chapterId) {
      const request = App.createRequest({
        url: `${MANGAPANDAONL_DOMAIN}/${chapterId}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getViewMoreItems(homepageSectionId, metadata) {
      ...
      const request = App.createRequest({
        url: `${MANGAPANDAONL_DOMAIN}/${homepageSectionId}?page=${page}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getSearchResults(query, metadata) {
      ...
      const request = App.createRequest({
        url: `${MANGAPANDAONL_DOMAIN}/search?q=${searchQuery}&page=${page}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
  ...
  return __toCommonJS(Mangapandaonl_exports);
})();
