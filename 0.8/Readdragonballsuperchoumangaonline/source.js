...
var _Sources = (() => {
  ...
  // src/Readdragonballsuperchoumangaonline/Readdragonballsuperchoumangaonline.ts
  var Readdragonballsuperchoumangaonline_exports = {};
  __export(Readdragonballsuperchoumangaonline_exports, {
    Readdragonballsuperchoumangaonline: () => Readdragonballsuperchoumangaonline,
    ReaddragonballsuperchoumangaonlineInfo: () => ReaddragonballsuperchoumangaonlineInfo
  });
  var import_types = __toESM(require_lib());

  // src/Readdragonballsuperchoumangaonline/ReaddragonballsuperchoumangaonlineParser.ts
  ...
  // src/Readdragonballsuperchoumangaonline/ReaddragonballsuperchoumangaonlineSettings.ts
  ...
  // src/Readdragonballsuperchoumangaonline/Readdragonballsuperchoumangaonline.ts
  var READDRAGONBALLSUPERCHOUMANGAONLINE_DOMAIN = "https://ww10.dbsmanga.com";
  var ReaddragonballsuperchoumangaonlineInfo = {
    version: "1.0.0",
    name: "Read Dragon Ball Super Chou Manga Online",
    icon: "icon.png",
    author: "Generated",
    authorWebsite: "",
    description: "Extension that pulls manga from Read Dragon Ball Super Chou Manga Online",
    contentRating: import_types.ContentRating.EVERYONE,
    websiteBaseURL: READDRAGONBALLSUPERCHOUMANGAONLINE_DOMAIN,
  ...
  var Readdragonballsuperchoumangaonline = class {
    constructor(cheerio) {
      this.cheerio = cheerio;
        ...
        interceptor: {
          interceptRequest: async (request) => {
            request.headers = {
              ...request.headers ?? {},
              ...{
                "referer": `${READDRAGONBALLSUPERCHOUMANGAONLINE_DOMAIN}/`,
    ...
    getMangaShareUrl(mangaId) {
      return `${READDRAGONBALLSUPERCHOUMANGAONLINE_DOMAIN}/${mangaId}`;
    }
    async getMangaDetails(mangaId) {
      const request = App.createRequest({
        url: `${READDRAGONBALLSUPERCHOUMANGAONLINE_DOMAIN}/${mangaId}`,
        method: "GET"
      });
    ...
    async getChapterDetails(mangaId, chapterId) {
      const request = App.createRequest({
        url: `${READDRAGONBALLSUPERCHOUMANGAONLINE_DOMAIN}/${chapterId}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getHomePageSections(sectionCallback) {
      const request = App.createRequest({
        url: READDRAGONBALLSUPERCHOUMANGAONLINE_DOMAIN,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getViewMoreItems(homepageSectionId, metadata) {
      ...
      const request = App.createRequest({
        url: `${READDRAGONBALLSUPERCHOUMANGAONLINE_DOMAIN}/${homepageSectionId}?page=${page}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getSearchResults(query, metadata) {
      ...
      const request = App.createRequest({
        url: `${READDRAGONBALLSUPERCHOUMANGAONLINE_DOMAIN}/search?q=${searchQuery}&page=${page}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
  ...
  return __toCommonJS(Readdragonballsuperchoumangaonline_exports);
})();
