...
var _Sources = (() => {
  ...
  // src/Readthepromisedneverlandmangaonline/Readthepromisedneverlandmangaonline.ts
  var Readthepromisedneverlandmangaonline_exports = {};
  __export(Readthepromisedneverlandmangaonline_exports, {
    Readthepromisedneverlandmangaonline: () => Readthepromisedneverlandmangaonline,
    ReadthepromisedneverlandmangaonlineInfo: () => ReadthepromisedneverlandmangaonlineInfo
  });
  var import_types2 = __toESM(require_lib());

  // src/Readthepromisedneverlandmangaonline/ReadthepromisedneverlandmangaonlineParser.ts
  ...
  // src/Readthepromisedneverlandmangaonline/ReadthepromisedneverlandmangaonlineSettings.ts
  ...
  // src/Readthepromisedneverlandmangaonline/Readthepromisedneverlandmangaonline.ts
  var READTHEPROMISEDNEVERLANDMANGAONLINE_DOMAIN = "https://ww7.readneverland.com";
  var ReadthepromisedneverlandmangaonlineInfo = {
    version: "1.0.0",
    name: "Read The Promised Neverland Manga Online",
    icon: "icon.png",
    author: "Generated",
    authorWebsite: "",
    description: "Extension that pulls manga from https://ww7.readneverland.com",
    contentRating: import_types2.ContentRating.EVERYONE,
    websiteBaseURL: "https://ww7.readneverland.com",
  ...
  var Readthepromisedneverlandmangaonline = class {
    constructor() {
  ...
  return __toCommonJS(Readthepromisedneverlandmangaonline_exports);
})();
