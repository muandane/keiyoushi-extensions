...
var _Sources = (() => {
  ...
  // src/Honkaiimpact3rd/Honkaiimpact3rd.ts
  var Honkaiimpact3rd_exports = {};
  __export(Honkaiimpact3rd_exports, {
    Honkaiimpact3rd: () => Honkaiimpact3rd,
    Honkaiimpact3rdInfo: () => Honkaiimpact3rdInfo
  });
  var import_types2 = __toESM(require_lib());

  // src/Honkaiimpact3rd/Honkaiimpact3rdParser.ts
  ...
  // src/Honkaiimpact3rd/Honkaiimpact3rdSettings.ts
  ...
  // src/Honkaiimpact3rd/Honkaiimpact3rd.ts
  var HONKAIIMPACT3RD_DOMAIN = "https://manga.honkaiimpact3.com";
  var Honkaiimpact3rdInfo = {
    version: "1.0.0",
    name: "Honkai Impact 3rd",
    icon: "icon.png",
    author: "Generated",
    authorWebsite: "",
    description: "Extension that pulls manga from Honkai Impact 3rd",
    contentRating: import_types2.ContentRating.EVERYONE,
    websiteBaseURL: HONKAIIMPACT3RD_DOMAIN,
  ...
  var Honkaiimpact3rd = class {
    ...
    async getMangaDetails(mangaId) {
      const request = App.createRequest({
        url: `${HONKAIIMPACT3RD_DOMAIN}/${mangaId}`,
        method: "GET"
      });
    ...
    async getChapterDetails(mangaId, chapterId) {
      const request = App.createRequest({
        url: `${HONKAIIMPACT3RD_DOMAIN}/${chapterId}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getViewMoreItems(homepageSectionId, metadata) {
      ...
      const request = App.createRequest({
        url: `${HONKAIIMPACT3RD_DOMAIN}/${homepageSectionId}?page=${page}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getSearchResults(query, metadata) {
      ...
      const request = App.createRequest({
        url: `${HONKAIIMPACT3RD_DOMAIN}/search?q=${searchQuery}&page=${page}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
  ...
  return __toCommonJS(Honkaiimpact3rd_exports);
})();
