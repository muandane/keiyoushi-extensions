...
var _Sources = (() => {
  ...
  // src/Pomanga/Pomanga.ts
  var Pomanga_exports = {};
  __export(Pomanga_exports, {
    Pomanga: () => Pomanga,
    PomangaInfo: () => PomangaInfo
  });
  var import_types = __toESM(require_lib());

  // src/Pomanga/PomangaParser.ts
  ...
  // src/Pomanga/PomangaSettings.ts
  ...
  // src/Pomanga/Pomanga.ts
  var POMANGA_DOMAIN = "https://pomanga.com";
  var PomangaInfo = {
    version: "1.0.0",
    name: "PoManga",
    icon: "icon.png",
  ...
  return __toCommonJS(Pomanga_exports);
})();
