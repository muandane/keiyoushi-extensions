...
var _Sources = (() => {
  ...
  // src/Solarandsundry/Solarandsundry.ts
  var Solarandsundry_exports = {};
  __export(Solarandsundry_exports, {
    Solarandsundry: () => Solarandsundry,
    SolarandsundryInfo: () => SolarandsundryInfo
  });
  var import_types2 = __toESM(require_lib());

  // src/Solarandsundry/SolarandsundryParser.ts
  ...
  // src/Solarandsundry/SolarandsundrySettings.ts
  ...
  // src/Solarandsundry/Solarandsundry.ts
  var SOLARANDSUNDRY_DOMAIN = "https://sas-api.fly.dev";
  var SolarandsundryInfo = {
    version: "1.0.0",
  ...
  return __toCommonJS(Solarandsundry_exports);
})();
