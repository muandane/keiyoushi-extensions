...
var _Sources = (() => {
  ...
  // src/Mangatellers/Mangatellers.ts
  var Mangatellers_exports = {};
  __export(Mangatellers_exports, {
  ...
  // src/Mangatellers/Mangatellers.ts
  var MANGATELLERS_DOMAIN = "https://reader.mangatellers.gr";
  var MangatellersInfo = {
    version: "1.0.0",
    name: "Mangatellers",
    icon: "icon.png",
    author: "Generated",
