...
var _Sources = (() => {
  ...
  // src/Arcrelight/Arcrelight.ts
  var Arcrelight_exports = {};
  __export(Arcrelight_exports, {
    Arcrelight: () => Arcrelight,
    ArcrelightInfo: () => ArcrelightInfo
  });
  var import_types2 = __toESM(require_lib());

  // src/Arcrelight/ArcrelightParser.ts
  ...
  // src/Arcrelight/ArcrelightSettings.ts
  ...
  // src/Arcrelight/Arcrelight.ts
  var ARCRELIGHT_DOMAIN = "https://arc-relight.com";
  var ArcrelightInfo = {
    version: "1.0.0",
    name: "Arc-Relight",
    icon: "icon.png",
    author: "Generated",
    authorWebsite: "",
    description: "Extension that pulls manga from Arc-Relight",
    contentRating: import_types2.ContentRating.EVERYONE,
    websiteBaseURL: ARCRELIGHT_DOMAIN,
  ...
  var Arcrelight = class {
    ...
    async getChapterDetails(mangaId, chapterId) {
      const request = App.createRequest({
        url: `${ARCRELIGHT_DOMAIN}/${chapterId}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getViewMoreItems(homepageSectionId, metadata) {
      ...
      const request = App.createRequest({
        url: `${ARCRELIGHT_DOMAIN}/${homepageSectionId}?page=${page}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getSearchResults(query, metadata) {
      ...
      const request = App.createRequest({
        url: `${ARCRELIGHT_DOMAIN}/search?q=${searchQuery}&page=${page}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
  ...
  return __toCommonJS(Arcrelight_exports);
})();
