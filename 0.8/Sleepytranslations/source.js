...
var _Sources = (() => {
  ...
  // src/Sleepytranslations/Sleepytranslations.ts
  var Sleepytranslations_exports = {};
  __export(Sleepytranslations_exports, {
    Sleepytranslations: () => Sleepytranslations,
    SleepytranslationsInfo: () => SleepytranslationsInfo
  });
  var import_types2 = __toESM(require_lib());

  // src/Sleepytranslations/SleepytranslationsParser.ts
  ...
  // src/Sleepytranslations/SleepytranslationsSettings.ts
  ...
  // src/Sleepytranslations/Sleepytranslations.ts
  var SLEEPYTRANSLATIONS_DOMAIN = "https://sleepytranslations.com";
  var SleepytranslationsInfo = {
    version: "1.0.0",
    name: "Sleepy Translations",
    icon: "icon.png",
    author: "Generated",
    authorWebsite: "",
    description: "Extension that pulls manga from Sleepy Translations",
    contentRating: import_types2.ContentRating.EVERYONE,
    websiteBaseURL: SLEEPYTRANSLATIONS_DOMAIN,
  ...
  var Sleepytranslations = class {
        ...
        interceptor: {
          interceptRequest: async (request) => {
            request.headers = {
              ...request.headers ?? {},
              ...{
                "referer": `${SLEEPYTRANSLATIONS_DOMAIN}/`,
    ...
    getMangaShareUrl(mangaId) {
      return `${SLEEPYTRANSLATIONS_DOMAIN}/${mangaId}`;
    }
    async getMangaDetails(mangaId) {
      const request = App.createRequest({
        url: `${SLEEPYTRANSLATIONS_DOMAIN}/${mangaId}`,
        method: "GET"
      });
    ...
    async getChapterDetails(mangaId, chapterId) {
      const request = App.createRequest({
        url: `${SLEEPYTRANSLATIONS_DOMAIN}/${chapterId}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getViewMoreItems(homepageSectionId, metadata) {
      ...
      const request = App.createRequest({
        url: `${SLEEPYTRANSLATIONS_DOMAIN}/${homepageSectionId}?page=${page}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getSearchResults(query, metadata) {
      ...
      const request = App.createRequest({
        url: `${SLEEPYTRANSLATIONS_DOMAIN}/search?q=${searchQuery}&page=${page}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
  ...
  return __toCommonJS(Sleepytranslations_exports);
})();
