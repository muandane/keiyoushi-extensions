...
var _Sources = (() => {
  ...
  // src/Taddyinkwebtoons/Taddyinkwebtoons.ts
  var Taddyinkwebtoons_exports = {};
  __export(Taddyinkwebtoons_exports, {
    Taddyinkwebtoons: () => Taddyinkwebtoons,
    TaddyinkwebtoonsInfo: () => TaddyinkwebtoonsInfo
  });
  var import_types2 = __toESM(require_lib());

  // src/Taddyinkwebtoons/TaddyinkwebtoonsParser.ts
  ...
  // src/Taddyinkwebtoons/TaddyinkwebtoonsSettings.ts
  ...
  // src/Taddyinkwebtoons/Taddyinkwebtoons.ts
  var TADDYINKWEBTOONS_DOMAIN = "https://taddy.org";
  var TaddyinkwebtoonsInfo = {
    version: "1.0.0",
    name: "Taddy INK (Webtoons)",
    icon: "icon.png",
    author: "Generated",
    authorWebsite: "",
    description: "Extension that pulls manga from Taddy INK (Webtoons)",
    contentRating: import_types2.ContentRating.EVERYONE,
    websiteBaseURL: TADDYINKWEBTOONS_DOMAIN,
  ...
  var Taddyinkwebtoons = class {
        ...
        interceptor: {
          interceptRequest: async (request) => {
            request.headers = {
              ...request.headers ?? {},
              ...{
                "referer": `${TADDYINKWEBTOONS_DOMAIN}/`,
    ...
    getMangaShareUrl(mangaId) {
      return `${TADDYINKWEBTOONS_DOMAIN}/${mangaId}`;
    }
    async getMangaDetails(mangaId) {
      const request = App.createRequest({
        url: `${TADDYINKWEBTOONS_DOMAIN}/${mangaId}`,
        method: "GET"
      });
    ...
    async getChapterDetails(mangaId, chapterId) {
      const request = App.createRequest({
        url: `${TADDYINKWEBTOONS_DOMAIN}/${chapterId}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getViewMoreItems(homepageSectionId, metadata) {
      ...
      const request = App.createRequest({
        url: `${TADDYINKWEBTOONS_DOMAIN}/${homepageSectionId}?page=${page}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
    ...
    async getSearchResults(query, metadata) {
      ...
      const request = App.createRequest({
        url: `${TADDYINKWEBTOONS_DOMAIN}/search?q=${searchQuery}&page=${page}`,
        method: "GET"
      });
      const response = await this.requestManager.schedule(request, 1);
      const $ = this.cheerio.load(response.data);
  ...
  return __toCommonJS(Taddyinkwebtoons_exports);
})();
