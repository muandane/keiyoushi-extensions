...
var _Sources = (() => {
  ...
  // src/Necroscans/Necroscans.ts
  var Necroscans_exports = {};
  __export(Necroscans_exports, {
    Necroscans: () => Necroscans,
    NecroscansInfo: () => NecroscansInfo
  });
  var import_types2 = __toESM(require_lib());

  // src/Necroscans/NecroscansParser.ts
  ...
  // src/Necroscans/NecroscansSettings.ts
  ...
  // src/Necroscans/Necroscans.ts
  var NECROSCANS_DOMAIN = "https://necroscans.com";
  var NecroscansInfo = {
    version: "1.0.0",
    name: "Necro Scans",
    icon: "icon.png",
    author: "Generated",
    authorWebsite: "",
    description: "Extension that pulls manga from https://necroscans.com",
    contentRating: import_types2.ContentRating.EVERYONE,
    websiteBaseURL: "https://necroscans.com",
  ...
  return __toCommonJS(Necroscans_exports);
})();
