...
var _Sources = (() => {
  ...
  // src/Alandal/Alandal.ts
  var Alandal_exports = {};
  __export(Alandal_exports, {
    Alandal: () => Alandal,
    AlandalInfo: () => AlandalInfo
  });
  var import_types = __toESM(require_lib());

  // src/Alandal/AlandalParser.ts
  ...
  // src/Alandal/AlandalSettings.ts
  ...
  // src/Alandal/Alandal.ts
  var ALANDAL_DOMAIN = "https://alandal.com";
  var AlandalInfo = {
    version: "1.0.0",
    name: "Alandal",
    icon: "icon.png",
  ...
  return __toCommonJS(Alandal_exports);
})();
