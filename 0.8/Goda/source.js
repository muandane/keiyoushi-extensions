...
var _Sources = (() => {
  ...
  // src/Goda/Goda.ts
  var Goda_exports = {};
  __export(Goda_exports, {
    Goda: () => Goda,
    GodaInfo: () => GodaInfo
  });
  var import_types2 = __toESM(require_lib());

  // src/Goda/GodaParser.ts
  ...
  // src/Goda/Goda.ts
  var GODA_DOMAIN = "https://manhuascans.org";
  var GodaInfo = {
    version: "1.0.0",
    name: "Goda",
    icon: "icon.png",
    author: "Generated",
    authorWebsite: "",
    description: "Extension that pulls manga from https://manhuascans.org",
    contentRating: import_types2.ContentRating.EVERYONE,
    websiteBaseURL: "https://manhuascans.org",
  ...
  return __toCommonJS(Goda_exports);
})();
