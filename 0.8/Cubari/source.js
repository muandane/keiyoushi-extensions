...
var _Sources = (() => {
  ...
  // src/Cubari/Cubari.ts
  var Cubari_exports = {};
  __export(Cubari_exports, {
    Cubari: () => Cubari,
    CubariInfo: () => CubariInfo
  });
  var import_types2 = __toESM(require_lib());

  // src/Cubari/CubariParser.ts
  ...
  // src/Cubari/Cubari.ts
  var CUBARI_DOMAIN = "https://cubari.moe";
  var CubariInfo = {
    version: "1.0.0",
    name: "Cubari",
    icon: "icon.png",
    author: "Generated",
    authorWebsite: "",
    description: "Extension that pulls manga from https://cubari.moe",
    contentRating: import_types2.ContentRating.EVERYONE,
    websiteBaseURL: "https://cubari.moe",
  ...
  return __toCommonJS(Cubari_exports);
})();
