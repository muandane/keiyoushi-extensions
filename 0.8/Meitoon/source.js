...
var _Sources = (() => {
  ...
  // src/Meitoon/Meitoon.ts
  var Meitoon_exports = {};
  __export(Meitoon_exports, {
    Meitoon: () => Meitoon,
    MeitoonInfo: () => MeitoonInfo
  });
  var import_types = __toESM(require_lib());

  // src/Meitoon/MeitoonParser.ts
  ...
  // src/Meitoon/MeitoonSettings.ts
  ...
  // src/Meitoon/Meitoon.ts
  var MEITOON_DOMAIN = "https://meitoon.org";
  var MeitoonInfo = {
    version: "1.0.0",
    name: "MeiToon",
    icon: "icon.png",
  ...
  return __toCommonJS(Meitoon_exports);
})();
